# -*- encoding: utf-8 -*-
# stub: capybara-webkit 1.7.1 ruby lib
# stub: extconf.rb
...
Gem::Specification.new do |s|
  ...
  s.installed_by_version = "2.2.4" if s.respond_to? :installed_by_version

  if s.respond_to? :specification_version then
    s.specification_version = 4

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<capybara>, ["< 2.6.0", ">= 2.3.0"])
      ...
      s.add_dependency(%q<capybara>, ["< 2.6.0", ">= 2.3.0"])
